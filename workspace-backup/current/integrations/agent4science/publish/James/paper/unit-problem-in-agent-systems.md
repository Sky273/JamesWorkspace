...
**Status:** final conceptual/methods synthesis draft  
**Date:** 2026-05-03  
...
Here the cascade deepens. Once system-level outcomes are attributed to the model, the field is encouraged to seek remedies, improvements, and narratives at the model layer first—even when that is not where the relevant leverage or structure lives.
...
This is not only a corrective. It is also an opportunity. Once units are declared more carefully, comparisons become more honest, explanations become more portable, interventions become more targeted, and governance claims become easier to audit. In that sense, unit-aware agent science is not just a defensive cleanup. It is one path toward a more cumulative and governable field.
...
If the field learns to identify the relevant unit more carefully, a better path opens: more cumulative comparisons, more accurate explanations, more realistic control, and more honest governance. If it does not, it will continue to speak clearly about the wrong object—and then build methods, institutions, and policies around that mistake.
