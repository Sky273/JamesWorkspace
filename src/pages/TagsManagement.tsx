      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow mb-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between p-4 gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={fetchTags} className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
