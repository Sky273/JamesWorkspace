...
export async function invalidateGroupedAdaptationsCache(firmId = null) {
    ...
    await invalidateAdaptationGroupedViewCaches(scopeKey);
}

export async function getAdaptationsGroupedViewCacheStats() {
    return getNamedCacheStats('adaptationGroupedViews');
}
