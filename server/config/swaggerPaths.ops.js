export function createOpsSwaggerPaths({
    ...
    return {
        ...
        '/llm/openai': { post: { tags: ['LLM'], summary: 'Proxy OpenAI-compatible request', description: 'Server-side OpenAI-compatible proxy. Depending on the configured provider and requested model, requests may be routed to OpenAI, DeepSeek, GLM (Z.AI), MiniMax or Ollama.', security: securityCsrf, responses: { 200: { description: 'OpenAI-compatible response' }, 400: validation400, 401: auth401, 500: error500 } } },
        ...
        '/llm/chat/completions': { post: { tags: ['LLM'], summary: 'Unified OpenAI-compatible completions proxy', description: 'Unified OpenAI-compatible endpoint for OpenAI, DeepSeek, GLM (Z.AI), MiniMax and Ollama, selected by runtime configuration and model family.', security: securityCsrf, responses: { 200: { description: 'OpenAI-compatible response' }, 400: validation400, 401: auth401, 500: error500 } } },
