        ...
        if (extractedImages.length > 0 && result.template) {
            ...
            if (result.template.headerContent) {
                ...
                result.template.headerContent = result.template.headerContent
                    .replace(/<img[^>]*src=['"]logo\.png['"][^>]*>/gi, `<img src="${logoBase64Data}" alt="Logo" class="template-logo" style="max-height:60px;">`)
                    .replace(/<img[^>]*src=['"][^'"]*logo[^'"]*['"][^>]*>/gi, `<img src="${logoBase64Data}" alt="Logo" class="template-logo" style="max-height:60px;">`)
                    .replace(/\[LOGO\]/gi, `<img src="${logoBase64Data}" alt="Logo" class="template-logo" style="max-height:60px;">`)
                    .replace(/-logo-/gi, `<img src="${logoBase64Data}" alt="Logo" class="template-logo" style="max-height:60px;">`);
            }
