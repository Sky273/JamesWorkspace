...
describe('HeaderActions', () => {
  it('renders a compact theme, language, and version control group', () => {
    ...
    expect(screen.getByRole('button', { name: 'header.theme.dark' })).toHaveClass('dark:text-[#F8FAFC]');
    expect(screen.getByText(`v${packageJson.version}`)).toHaveClass('dark:text-[#FFFFFF]');
