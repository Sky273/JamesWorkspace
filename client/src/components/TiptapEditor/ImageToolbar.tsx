/**
 * ImageToolbar - Contextual toolbar shown below the main toolbar when an image is selected.
 * Replaces the BubbleMenu approach which was clipped by the overflow container.
 */
...
export const ImageToolbar = ({ editor }: ImageToolbarProps) => {
  ...
  useEffect(() => {
    const checkImageSelection = () => {
      ...
      const selected = isNodeSelection(selection) && editor.isActive('image');
      setIsImageSelected(selected);
      // Reset to quick panel when deselecting
      if (!selected) setPanel('quick');
    };
  ...
  // Form state for image properties
  ...
  return (
    <div className="tiptap-image-toolbar">
      {/* ---- Quick Actions ---- */}
      {panel === 'quick' && (
        <div className="tiptap-image-toolbar-row">
          {/* Size presets */}
          <span className="tiptap-image-toolbar-label">Taille</span>
          ...
          {/* Alignment */}
          <span className="tiptap-image-toolbar-label">Alignement</span>
          ...
          <div className="tiptap-image-toolbar-fields">
            <label>
              ...
              <select
                ...
                className="tiptap-image-toolbar-select"
              >
            ...
            <label>
              <span>Couleur</span>
              <div className="tiptap-image-toolbar-color-row">
                <input type="color" value={borderColor || '#000000'} onChange={(e) => setBorderColor(e.target.value)} className="tiptap-image-toolbar-color-input" />
            ...
            <div className="tiptap-image-toolbar-sublabel">Ombre</div>
