    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 pt-3 border-t border-gray-200 dark:border-gray-700">
          <button onClick={handleEditClick} className="btn btn-primary flex-1 flex items-center justify-center gap-1 px-3 py-2 text-sm">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow mb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between p-4 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => setIsExtractModalOpen(true)} className="btn btn-secondary flex items-center gap-2 px-4 py-2" title={t('templates.extract.title')}><SparklesIcon className="w-5 h-5" /><span className="hidden sm:inline">{t('templates.extract.buttonShort')}</span></button>
            <button onClick={() => navigate('/templates/new')} className="btn btn-primary flex items-center gap-2 px-4 py-2"><PlusIcon className="w-5 h-5" />{t('templates.newTemplate')}</button>
          </div>
        </div>
      </div>
