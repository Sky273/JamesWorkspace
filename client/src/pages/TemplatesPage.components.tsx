    ...
    <AnimatedCard index={index} className="shadow-md overflow-hidden">
      ...
      >
        <div className="h-48 bg-gray-50 dark:bg-gray-900 overflow-hidden">
          <Suspense fallback={<div className="flex h-full min-h-48 items-center justify-center text-xs text-gray-400 dark:text-gray-500">{t('templates.preview.loading')}</div>}>
